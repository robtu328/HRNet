...
class Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn3 = SyncBatchNorm(planes*self.expansion) # add_module(self.norm3_name, norm3)
...
class SyncResNet(nn.Module):
    ...
    def __init__(self,
        ...
        super(SyncResNet, self).__init__()
    ...
    def train(self, mode=True):
        super(SyncResNet, self).train(mode)
